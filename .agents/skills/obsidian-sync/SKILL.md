...
This project skill is intended for explicit use as `obsidian-sync`, and it also applies whenever project instructions require Obsidian documentation synchronization.
